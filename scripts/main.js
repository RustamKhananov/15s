...
function gameFifteen(event) {
  ...
  document.querySelector('.game15Block__button--decrease').style.display = 'block';
  document.querySelector('.game15Block__button--random').style.display = 'block';
  ...
  function game(event) {
    ...
    if (event.target !== document.querySelector('.game15Block__button--decrease')
    ...
    document.querySelector('.game15Block__button--random').style.display = 'none';
    ...
    function backToStart() {
      ...
      document.querySelector('.game15Block__button--start').style.display = 'block';
    }

    function orderChange(event) {
      let targetIndex = chips.indexOf(event.target);
      //if click on left
      if (parseInt(event.target.style.top) === emptyCellTop
      ...
      //if click on top
      if (parseInt(event.target.style.top) === emptyCellTop - chipHeight
...
document.querySelector('.game15Block__button--start').addEventListener('click', gameFifteen)
